...
import static vip.floatationdevice.msu.deathpenalty.DeathPenalty.instance;
import static vip.floatationdevice.msu.deathpenalty.DeathPenalty.log;
...
public class EconomyManager
{
    ...
    static boolean initialize()
    {
        ...
        if(!available)
            log.warning("Vault economy not found, setting money will not work");
    ...
    static double setBalance(Player player, double balance)
    {
        ...
        if(d < 0)
        {
            ...
            if(resp.transactionSuccess())
                ...
                throw new RuntimeException("Failed to set balance for " + player.getName() + ": " + resp.errorMessage);
        }
